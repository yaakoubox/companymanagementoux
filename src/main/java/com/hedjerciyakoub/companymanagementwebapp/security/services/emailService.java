...
public class emailService implements EmailSender {
    ...
    @Override
    @Async
    public void send(String to, String username, String link) {
        String email = "";
        String subject = "";
        if(link.contains("confirm")) {
            email = buildEmailForConfirmation(username, link);
            subject="Confirm your email";
        }else if (link.contains("resetepassword")){
            email = buildEmailForResetPassword(username,link);
        ...
        try{
            ...
            helper.setFrom("ouxcompanymanagement@gmail.com");
            System.out.println("=============================================");
...
//            throw new IllegalStateException("failed to send email");
    ...
    private String buildEmailForConfirmation(String username, String link) {
    ...
    private String buildEmailForResetPassword(String username, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
